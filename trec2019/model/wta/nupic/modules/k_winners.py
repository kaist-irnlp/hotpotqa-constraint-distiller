...
import trec2019.model.wta.nupic.functions as F
from trec2019.model.wta.nupic.duty_cycle_metrics import binary_entropy, max_entropy
...
class KWinners2d(KWinnersBase):
    ...
    def extra_repr(self):
        s = (
            f"channels={self.channels}, local={self.local}"
